...
For assistance with anything please contact [mailto:opendata@landgate.wa.gov.au](opendata@landgate.wa.gov.au).
...
To create an account, go to [http://catalogue.beta.data.wa.gov.au/user/register](http://catalogue.beta.data.wa.gov.au/user/register) and complete the form on the page. Then email [mailto:opendata@landgate.wa.gov.au](opendata@landgate.wa.gov.au) with the following email to verify who you are and that you wish to be granted publishing privileges:
...
If you would like to rename, remove, move your data within SLIP, please contact [mailto:slipservices@landgate.wa.gov.au](slipservices@landgate.wa.gov.au) before taking any action (e.g. deleting a dataset, setting its visiblity to Private) in data.wa.gov.au so we can coordinate the process.
